...
class AdditionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->addition = Addition::factory()->create();
        $this->url = '/api/dashboard/categories/' . $this->category['id'] . '/additions';
    }
    ...
    {
        $response = $this->actingAs($this->user)->getJson('/api/dashboard/categories/1001/additions');
...
//            'payload'       => null
    ...
    public function test_store_with_non_existing_category()
    {
        $response = $this->actingAs($this->user)
            ->postJson('/api/dashboard/categories/1001/additions', $this->data());
        $response->assertStatus(404)->assertJson([
            'msg'           => "Not Found",
            'isSuccess'     => false,
            'statusCode'    => 404,
    ...
    public function test_store_without_has_discount_parameter()
    {
        ...
        $response->assertStatus(201)->assertJson([
            'msg'           => "Addition is created successfully",
            'isSuccess'     => true,
            'statusCode'    => 201,
//            'payload'       => null
        ]);
        $this->assertDatabaseCount('additions', 2);
    }
...
//            'payload'       => null
    ...
    {
        $response = $this->putJson($this->url . '/' . $this->addition['id']);
        $response->assertStatus(401)->assertJson($this->unauthenticated());
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson('/api/dashboard/categories/1001/additions' . '/' . $this->addition['id'],
                $this->data());
        $response->assertStatus(404)->assertJson([
            'msg'           => "Not Found",
            'isSuccess'     => false,
    ...
    public function test_update_with_non_existing_addition()
    {
        $response = $this->actingAs($this->user)
            ->putJson('/api/dashboard/categories/1001/additions' . '/1001', $this->data());
        $response->assertStatus(404)->assertJson([
            'msg'           => "Not Found",
            'isSuccess'     => false,
            'statusCode'    => 404,
    ...
    {
        $response = $this->actingAs($this->user)->putJson($this->url . '/' . $this->addition['id']);
        $response->assertStatus(422)
            ->assertJson($this->validationError('The name en field is required.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_en' => '']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The name en field is required.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_en' => 'in']));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The name en must be between 3 and 50 characters.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_en' => 'I\'m very Happy to learn DDT to test my code and improve my skills']));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The name en must be between 3 and 50 characters.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_ar' => '']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The name ar field is required.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_ar' => 'فط']));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The name ar must be between 3 and 50 characters.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['name_ar' => 'I\'m very Happy to learn DDT to test my code and improve my skills']));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The name ar must be between 3 and 50 characters.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['price' => '']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The price field is required.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['price' => 'test']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The price must be a number.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['price' => -50]));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The price must be between 0 and 999999.99.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['price' => 1000000]));
        $response->assertStatus(422)
            ->assertJson(
                $this->validationError('The price must be between 0 and 999999.99.')
            );
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['has_discount' => '']));
        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition is updated successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
//            'payload'       => null
        ]);
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['has_discount' => 'test']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The selected has discount is invalid.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['discount' => '']));
        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition is updated successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
//            'payload'       => null
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['discount' => 'test']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The discount must be a number.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['discount' => -5]));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The discount must be between 0 and 100.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['discount' => 150]));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The discount must be between 0 and 100.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['active' => '']));
        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition is updated successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
//            'payload'       => null
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data(['active' => 'test']));
        $response->assertStatus(422)
            ->assertJson($this->validationError('The selected active is invalid.'));
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->putJson($this->url . '/' . $this->addition['id'], $this->data());
        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition is updated successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
//            'payload'       => null
    ...
    {
        $response = $this->deleteJson($this->url . '/' . $this->addition['id']);
        $response->assertStatus(401)->assertJson($this->unauthenticated());
    }
    ...
    {
        $response = $this->actingAs($this->user)
            ->deleteJson('/api/dashboard/categories/1001/additions/' . $this->addition['id']);
        $response->assertStatus(404)->assertJson([
            'msg'           => "Not Found",
            'isSuccess'     => false,
            'statusCode'    => 404,
    ...
    public function test_delete_existing_addition()
    {
        $response = $this->actingAs($this->user)
            ->deleteJson($this->url . '/' . $this->addition['id']);
        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition is deleted successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
            'payload'       => true
        ]);
    ...
    public function test_delete_non_existing_addition()
    {
    ...
    {
        $response = $this->putJson($this->url . '/' . $this->addition['id'] . '/change-status');
        $response->assertStatus(401)->assertJson($this->unauthenticated());
    }
    ...
    public function test_change_status_with_non_existing_category()
    {
        $response = $this->actingAs($this->user)->putJson(
            '/api/dashboard/categories/1001/additions/' . $this->addition['id'] . '/change-status'
        );
    ...
    {
        $response = $this->actingAs($this->user)->putJson(
            $this->url . '/' . $this->addition['id'] . '/change-status'
        );

        $response->assertStatus(202)->assertJson([
            'msg'           => "Addition status is changed successfully",
            'isSuccess'     => true,
            'statusCode'    => 202,
            'payload'       => true
        ]);
    ...
    public function test_change_status_non_existing_addition()
    {
        $response = $this->actingAs($this->user)
